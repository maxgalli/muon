...
\begin{figure}[H]
	\centering
		\begin{minipage}{.5\textwidth}
			\centering
			\subfloat[][]{\includegraphics[width=1\textwidth]{excel-plots/disc-L00.jpg}\label{fig:disc-L00}}\quad
		\end{minipage}%
		\begin{minipage}{.5\textwidth}
			\centering
			\subfloat[][]{\includegraphics[width=1\textwidth]{excel-plots/disc-R00.jpg}\label{fig:disc-L01}}\quad
		\end{minipage}
	\begin{minipage}{.5\textwidth}
		\centering
		\subfloat[][]{\includegraphics[width=1\textwidth]{excel-plots/disc-L01.jpg}\label{fig:disc-L00}}\quad
	\end{minipage}%
	\begin{minipage}{.5\textwidth}
		\centering
		\subfloat[][]{\includegraphics[width=1\textwidth]{excel-plots/disc-R01.jpg}\label{fig:disc-L01}}\quad
	\end{minipage}
...
\begin{figure}[H]
	\centering
		\begin{minipage}{.5\textwidth}
			\centering
			\subfloat[][]{\includegraphics[width=1\textwidth]{excel-plots/disc-L10.jpg}\label{fig:disc-L00}}\quad
		\end{minipage}%
		\begin{minipage}{.5\textwidth}
			\centering
			\subfloat[][]{\includegraphics[width=1\textwidth]{excel-plots/disc-R10.jpg}\label{fig:disc-L01}}\quad
		\end{minipage}
		\begin{minipage}{.5\textwidth}
			\centering
			\subfloat[][]{\includegraphics[width=1\textwidth]{excel-plots/disc-L11.jpg}\label{fig:disc-L00}}\quad
		\end{minipage}%
		\begin{minipage}{.5\textwidth}
			\centering
			\subfloat[][]{\includegraphics[width=1\textwidth]{excel-plots/disc-R11.jpg}\label{fig:disc-L01}}\quad
		\end{minipage}
