...
\begin{figure}[H]
  \centering
  \subfloat[][]{\includegraphics[width=\textwidth]{images/mu_stop_alto.jpg}\label{mu_stop_alto}}\\
  \subfloat[][]{\includegraphics[width=\textwidth]{images/mu_stop2.jpg}\label{mu_stop}}\\
  \caption{Schematizzazione degli eventi $\mu_{stop}$ nel rivelatore.}
  \label{fig:mu_stops}
\end{figure}
