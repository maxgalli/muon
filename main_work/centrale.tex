...
Essendo il CIA un modulo CAMAC i dati sono stati acquisiti tramite un semplice programma in LabView. I risultati dell'analisi dei dati cos\`i raccolti forniscono,come ci si poteva aspettare, delle distribuzioni di Landau (vedi Figura \ref{energy} a titolo di esempio e tutte le curve in Appendice). La stima di rumore elettronico e termico \`e effettuata in Appendice.
