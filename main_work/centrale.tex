...
Essendo il CIA un modulo CAMAC i dati sono stati acquisiti tramite un semplice programma in LabView. I risultati dell'analisi dei dati così raccolti forniscono,come ci si poteva aspettare, delle distribuzioni di Landau (vedi Figura \ref{energy} a titolo di esempio e tutte le curve in Appendice). La stima di rumore elettronico e termico \`e effettuata in Appendice.
...
\begin{enumerate}[label=(\alph*)]
  ...
  \item stesso taglio del punto precedente, ma con in pi\`u la condizione che il segnale sul piano 1 sia antecedente rispetto a quello sul piano 0, così da scartare muoni che potrebbero essere scambiati per elettroni di decadimento.
\end{enumerate}
